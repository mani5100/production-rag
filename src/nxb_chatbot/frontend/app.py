...
# Prevent Chainlit from treating the backend SQLAlchemy URL
# as its own persistence database.
...
async def on_message(message: cl.Message) -> None:
    ...
    try:
        ...
        # Show the streaming TTS button only when an actual
        # assistant answer was returned.
